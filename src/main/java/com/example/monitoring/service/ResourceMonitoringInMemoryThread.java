...
public class ResourceMonitoringInMemoryThread extends Thread {

    private final CloseableHttpClient httpClient = HttpClients.createDefault();
    ResourceForMonitoring resourceForMonitoring;


    public ResourceMonitoringInMemoryThread(ResourceForMonitoring resourceForMonitoring) {
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(ResourceMonitoringInMemoryThread.class.getName()).log(Level.SEVERE, null, ex);
        }
